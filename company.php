    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo web_root; ?>images/bg_6.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="<?php echo web_root.'index.php?q=hiring&search='.$company->COMPANYNAME; ?>" class="block-20" style="background-image: url('');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">April 11, 2021</a></div>
